...
mysql_query("UPDATE `producto` SET idProducto=$idProducto, nombreProducto='$nombreProducto', precio=$precio, descripcion='$descripcion',propiedades='$propiedades', existencias=$existencias, imagen ='$imagen' WHERE idProducto=$idProducto");
